...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('cart_items', function (Blueprint $table) {
            $table->foreignId('menu_item_id')->after('session_id')->constrained('menu_items')->cascadeOnDelete();
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('cart_items', function (Blueprint $table) {
            $table->foreignId('product_id')->after('session_id')->constrained('menu_items')->cascadeOnDelete();
        });
    }
};
