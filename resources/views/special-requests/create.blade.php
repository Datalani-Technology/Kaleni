...
<style>
    ...
    .sr-heading { text-align: center; margin-bottom: 32px; }
    .sr-heading h1 { font-size: clamp(1.9rem, 4vw, 2.7rem); font-weight: 800; margin: 6px 0 10px; }
    .sr-heading p { max-width: 560px; margin: 0 auto; color: var(--muted); }
        ...
        <form action="{{ route('special-requests.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" min="1" max="5000" class="form-control @error('guest_count') is-invalid @enderror" id="guest_count" name="guest_count" value="{{ old('guest_count') }}" required>
