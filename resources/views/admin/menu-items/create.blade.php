        ...
        <form action="{{ route('admin.menu-items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('unit_label') is-invalid @enderror" id="unit_label" name="unit_label" value="{{ old('unit_label') }}" placeholder="e.g. per person, per pack">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" min="1" class="form-control @error('serves_count') is-invalid @enderror" id="serves_count" name="serves_count" value="{{ old('serves_count') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ old('category') }}" placeholder="e.g., Individual Meals, Sharing Platters">
            ...
            <div class="d-flex flex-wrap gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Create Menu Item</button>
