...
<body>
    <h1>Still want your booking, {{ $booking->customer_name }}? 🍽️</h1>
    <p>We noticed your card payment for booking <strong>{{ $booking->booking_number }}</strong> wasn't completed, so no charge was made. If you ran into trouble or changed your mind partway through, you can finish paying below, or reply to this email and we'll help directly.</p>
    <table>
        ...
        <tr><td class="muted">Event date</td><td>{{ $booking->event_date?->format('D, j M Y') ?: 'To be confirmed' }}</td></tr>
    </table>
